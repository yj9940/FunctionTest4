package com.example.lenovo.functiontest4.Weather;
...
import com.example.lenovo.functiontest4.R;
...
//                                sugg_n.setShushidu(xmlPullParser.getText());
                                ...
                                eventType = xmlPullParser.next();
                                SuggestString str =new SuggestString("紫外线强度：",xmlPullParser.getText());
                                arr.add(str);
                                zhishu_count++;
                            }
